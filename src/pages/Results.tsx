          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12 relative">
              ...
              <div className="inline-flex items-center gap-3 bg-white rounded-full px-6 py-3 shadow-lg mb-6">
                ...
                <span className="text-[#212121] font-semibold">Quiz Complete!</span>
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 rounded-2xl p-8 mb-8 shadow-lg">
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-[#212121] mb-3">Your Superpower Profile</h2>
                <p className="text-[#1A73E8] font-semibold text-lg">Creative Explorer with Leadership Spark ✨</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-6 text-center shadow-sm">
                  ...
                  <h3 className="text-lg font-semibold text-[#212121] mb-2">Creative Genius</h3>
                  <p className="text-gray-600 text-sm">You love making beautiful things and thinking outside the box!</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 text-center shadow-sm">
                  ...
                  <h3 className="text-lg font-semibold text-[#212121] mb-2">Team Helper</h3>
                  <p className="text-gray-600 text-sm">You're amazing at working with others and helping friends!</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 text-center shadow-sm">
                  ...
                  <h3 className="text-lg font-semibold text-[#212121] mb-2">Problem Solver</h3>
                  <p className="text-gray-600 text-sm">You never give up and always find clever solutions!</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 mb-8 shadow-lg">
              ...
              <div className="space-y-4">
                {[
                  { question: "Favorite Saturday Activity", answer: "Draw and Create Art", icon: "fa-solid fa-palette", color: "text-[#FF4081]" },
                  { question: "Learning Style", answer: "Working with Friends", icon: "fa-solid fa-users", color: "text-[#4CAF50]" },
                  { question: "Problem Solving", answer: "Try Different Solutions", icon: "fa-solid fa-lightbulb", color: "text-[#FFC107]" },
                  { question: "Future Dreams", answer: "Design Amazing Things", icon: "fa-solid fa-rocket", color: "text-[#9C27B0]" },
                  { question: "Helping Others", answer: "Love Helping Friends", icon: "fa-solid fa-heart", color: "text-[#FF4081]" }
                ].map((item, index) => (
                  <div key={index} className="bg-[#F5F7FA] rounded-xl p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-[#212121] font-medium">{item.question}</span>
                      <span className="text-[#1A73E8] text-sm">Question {index + 1}</span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-[#1A73E8] to-[#0D47A1] rounded-2xl p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-blue-100 mb-6 text-sm leading-relaxed">
                    Let our AI suggest fun activities, learning paths, and career ideas based on your superpowers!
                  </p>
              ...
              <div className="bg-gradient-to-br from-[#4CAF50] to-[#2E7D32] rounded-2xl p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold mb-3">Chat with AI Advisor</h3>
                  <p className="text-green-100 mb-6 text-sm leading-relaxed">
                    Ask questions about your results, explore career paths, or get advice from our friendly AI mentor!
                  </p>
            ...
            <div className="text-center mt-12">
              <div className="inline-flex items-center gap-4 bg-gradient-to-r from-[#FFC107] to-[#FF9800] text-white rounded-full px-8 py-4 shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-90">Quiz Explorer Badge Earned</p>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6 mt-8 shadow-lg">
              <div className="text-center">
                <h3 className="text-xl font-bold text-[#212121] mb-4">Share Your Superpowers! 🌟</h3>
                <p className="text-gray-600 mb-6">Let your friends and family know about your amazing discoveries!</p>
