...
const AgeSelection: React.FC<AgeSelectionProps> = ({ selectedAge, onAgeSelect, onContinue }) => {
  const ageGroups = [
    {
      range: '6-8',
      title: 'Ages 6 - 8',
      subtitle: 'Early Explorers 🌟',
      description: 'Fun questions with colorful pictures and simple choices. Perfect for little adventurers!',
    ...
    },
    {
      ...
      description: 'Interactive challenges with cool animations and brain-teasing puzzles for young innovators!',
    ...
    },
    {
      ...
      description: 'Deep thinking questions with real-world scenarios and future career insights!',
    ...
    },
    {
      ...
      description: 'Advanced assessments focusing on values, skills, and future career pathways!',
        ...
        <div className="text-center mb-12 relative">
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-3 bg-white rounded-full px-6 py-3 shadow-lg mb-6">
              ...
              <span className="text-[#212121] font-semibold">Let's Discover Your Superpowers!</span>
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Choose your age group so we can create the perfect quiz adventure just for you!
          </p>
        </div>
            ...
            >
              <div className="text-center relative">
                <div className="absolute -top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                  <i className={`fa-solid fa-star text-[#FFC107] text-2xl ${group.animation}`}></i>
                </div>
                
                <div className={`w-24 h-24 bg-gradient-to-br ${group.gradient} rounded-full mx-auto mb-6 flex items-center justify-center`}>
                  <i className={`${group.icon} text-white text-3xl`}></i>
                </div>
                
                <h3 className="text-2xl font-bold text-[#212121] mb-3">{group.title}</h3>
                <p className="text-[#1A73E8] font-semibold text-lg mb-4">{group.subtitle}</p>
                ...
                <div className="mt-6 flex justify-center gap-2">
                  ...
                  <div className="w-3 h-3 bg-[#FF4081] rounded-full animate-bounce" style={{animationDelay: '0.1s'}}></div>
                  <div className="w-3 h-3 bg-[#1A73E8] rounded-full animate-bounce" style={{animationDelay: '0.2s'}}></div>
                </div>
              </div>
            </div>
          ))}
