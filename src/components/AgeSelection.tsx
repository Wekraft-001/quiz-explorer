...
const AgeSelection: React.FC<AgeSelectionProps> = ({ onAgeSelect }) => {
  ...
  const handleCardClick = (age: string) => {
    setSelectedAge(age); // update styling
    onAgeSelect(age); // call parent to fetch quiz + navigate
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {ageGroups.map((group) => (
            <div
              ...
              onClick={() => handleCardClick(group.range)}
            >
